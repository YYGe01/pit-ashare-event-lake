...
```text
daily_bar / adj_factor / price_limit：CSI300 2023-01-03 -> 2024-12-31 已跑通，2026-05-11 两标的小样本已跑通。
...
部分完成：全市场任务规划和小样本真实采集。
未完成：all_a 全市场单日真实采集、连续 10 到 20 个交易日稳定性、PDF 正文抽取、公告类型标准化、交易所公告补源、授权历史新闻源。
下一步：推进 all_a 全市场单日运行，观察耗时、失败率和上游限流。
```
